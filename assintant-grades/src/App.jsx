  ...
  return (
    <>
      ...
      <div id="main">
        ...
        <div className="form-grid-3"><div className="form-group"><label className="form-label">Carrera</label><select className="form-select" id="cfg-carrera" onChange={noop}><option value="">-- Seleccione la carrera --</option><option value="TECNOLOGÍAS DE LA INFORMACIÓN">Tecnologías de la Información</option><option value="AMBIENTAL">Ambiental</option><option value="AGRONOMÍA">Agronomía</option><option value="ZOOTECNIA">Zootecnia</option><option value="TURISMO">Turismo</option><option value="DERECHO">Derecho</option></select></div><div className="form-group"><label className="form-label">PAO (Semestre)</label><select className="form-select" id="cfg-pao" onChange={noop} disabled><option value="">-- Seleccione PAO --</option></select></div><div className="form-group"><label className="form-label">Asignatura</label><select className="form-select" id="cfg-asignatura" disabled onChange={noop}><option value="">-- Seleccione primero Carrera y PAO --</option></select></div></div>
